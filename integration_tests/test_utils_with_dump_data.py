'''
    Will re-create db with data from dump folder
'''
...
import os
from import_export import load_ttl_files

env_var="DELETE_DB"
assert os.environ.get(env_var) == "Y", f"Set env var {env_var}=Y to confirm you want to drop database"
db.cypher_query("MATCH (n) DETACH DELETE n;")
load_ttl_files("dump")

class TestUtilsWithDumpData(SimpleTestCase):
