...
def refresh_all(limit=0):
    base_opts = {"batch_size":40,"limit":limit,"sleep":0,"id_starts_after":0,"save_metrics":True,"has_article":True}
    model_opts = [
        {"model_class": "topics.models.IndustrySectorUpdate", "has_article": False},
    ...
    for model_class_opts in model_opts:
        ...
        logger.info(f"**** RECREATING {model_class} with limit {limit} ****")
