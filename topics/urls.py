...
urlpatterns = [
    ...
    path('organization/incl_similar/activities/uri/<str:domain>/<str:path>/<doc_id>/<str:name>', views.OrgActivitiesView.as_view(), {"include_similar_orgs":True}, name='organization-activities-incl-similar'),
    path('organization/activities/uri/<str:domain>/<str:path>/<doc_id>/<str:name>', views.OrgActivitiesView.as_view(), name='organization-activities'),
    ...
    path('industry_orgs_activities', views.IndustryOrgsActivities.as_view(), name = 'industry-orgs-activities'),
