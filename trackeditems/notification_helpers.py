...
from topics.util import geo_to_country_admin1, filter_unique_records_and_allowed_activity_types
...
def tracked_items_between(tracked_items, min_date, max_date):
    ...
    matching_activity_orgs = filter_unique_records_and_allowed_activity_types(matching_activity_orgs)
